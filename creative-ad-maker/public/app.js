...
document.addEventListener('DOMContentLoaded', function() {  // Update Figma preview when selections change
  ...
  // Initialize input sections - REMOVED
});
...
function displayGeneratedImages(images) {
  ...
  if (images.editorial) {
    document.getElementById('editorialImage').src = images.editorial;
  }
...
// Remove the old createLifestyleImageDisplay function since lifestyle is now in the main grid
